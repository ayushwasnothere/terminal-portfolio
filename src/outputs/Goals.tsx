  ...
  return (
    <div style={{ color: colors.fg }}>
      ...
      <ul className="list-disc pl-5 flex flex-col space-y-1">
        <li>
          Build intelligent, autonomous CLI & terminal-native AI coding agents
          (Forge).
        </li>
        <li>
          Architect high-performance robotics software & ROS 2 motion planning
          packages.
        </li>
        <li>Master low-level systems programming in Rust and Go.</li>
        <li>
          Contribute impactful open-source tools to the developer ecosystem.
        </li>
        <li>
          Share technical insights, tutorials, and deep dives on my blog
          (cytrus.me).
        </li>
      </ul>
    </div>
